...
Y_all_bb <- bb_cf_all$prod_totprice
...
Y_all2_ama <- ama_cf_all2$PagesPerDollar 
...
ATE3_ama <- average_treatment_effect(cf3_ama, target.sample = "all")
paste("99% CI for the ATE:", round(ATE3_ama[1], 3),
      "+/-", round(qnorm(0.995) * ATE3_ama[2], 3))
...
paste("90% CI for the ATE:", round(ATE5_ama[1], 3),
      "+/-", round(qnorm(0.95) * ATE5_ama[2], 3))
