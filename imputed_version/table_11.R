...
ama.t11.pagesperdollar.0mile <- plm(log(PagesPerDollar + 1) ~ DID + THREEINTER, data = data_0m_t11_balanced[(data_0m_t11_balanced$domain_name == "amazon.com"),], index = c("Zip_Code", "Time"), model = "within", effect = "twoways")
ama.t11.minsperdollar.0mile <- plm(log(MinsPerDollar + 1) ~ DID + THREEINTER, data = data_0m_t11_balanced[(data_0m_t11_balanced$domain_name == "amazon.com"),], index = c("Zip_Code", "Time"), model = "within", effect = "twoways")

bb.t11.0mile.sale <- plm(log(TotalMonthlySales + 1) ~ DID + THREEINTER, data = data_0m_t11_balanced[(data_0m_t11_balanced$domain_name == "bestbuy.com"),], index = c("Zip_Code", "Time"), model = "within", effect = "twoways")
bb.t11.pagesperdollar.0mile <- plm(log(PagesPerDollar + 1) ~ DID + THREEINTER, data = data_0m_t11_balanced[(data_0m_t11_balanced$domain_name == "bestbuy.com"),], index = c("Zip_Code", "Time"), model = "within", effect = "twoways")
bb.t11.minsperdollar.0mile <- plm(log(MinsPerDollar + 1) ~ DID + THREEINTER, data = data_0m_t11_balanced[(data_0m_t11_balanced$domain_name == "bestbuy.com"),], index = c("Zip_Code", "Time"), model = "within", effect = "twoways")

stargazer(ama.t11.0mile.sale, bb.t11.0mile.sale,
          ama.t11.pagesperdollar.0mile, bb.t11.pagesperdollar.0mile,
          ama.t11.minsperdollar.0mile, bb.t11.minsperdollar.0mile,
