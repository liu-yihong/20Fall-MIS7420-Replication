...
data_0m_t6_exp <- dta_bal_imp_sale(data_0m_t6_exp)
data_0m_t6_search <- dta_bal_imp_sale(data_0m_t6_search)
data_5m_t6_exp <- dta_bal_imp_sale(data_5m_t6_exp)
data_5m_t6_search <- dta_bal_imp_sale(data_5m_t6_search)

# Table 6
ama.t6.0mile.exp <- plm(log(TotalMonthlySales + 1) ~ DID + THREEINTER, data = data_0m_t6_exp[data_0m_t6_exp$domain_name == "amazon.com",], index = c("Zip_Code", "Time"), model = "within", effect = "twoways")
ama.t6.5mile.exp <- plm(log(TotalMonthlySales + 1) ~ DID + THREEINTER, data = data_5m_t6_exp[data_5m_t6_exp$domain_name == "amazon.com",], index = c("Zip_Code", "Time"), model = "within", effect = "twoways")
ama.t6.0mile.search <- plm(log(TotalMonthlySales + 1) ~ DID + THREEINTER, data = data_0m_t6_search[data_0m_t6_search$domain_name == "amazon.com",], index = c("Zip_Code", "Time"), model = "within", effect = "twoways")
ama.t6.5mile.search <- plm(log(TotalMonthlySales + 1) ~ DID + THREEINTER, data = data_5m_t6_search[data_5m_t6_search$domain_name == "amazon.com",], index = c("Zip_Code", "Time"), model = "within", effect = "twoways")
bb.t6.0mile.exp <- plm(log(TotalMonthlySales + 1) ~ DID + THREEINTER, data = data_0m_t6_exp[data_0m_t6_exp$domain_name == "bestbuy.com",], index = c("Zip_Code", "Time"), model = "within", effect = "twoways")
bb.t6.5mile.exp <- plm(log(TotalMonthlySales + 1) ~ DID + THREEINTER, data = data_5m_t6_exp[data_5m_t6_exp$domain_name == "bestbuy.com",], index = c("Zip_Code", "Time"), model = "within", effect = "twoways")
bb.t6.0mile.search <- plm(log(TotalMonthlySales + 1) ~ DID + THREEINTER, data = data_0m_t6_search[data_0m_t6_search$domain_name == "bestbuy.com",], index = c("Zip_Code", "Time"), model = "within", effect = "twoways")
bb.t6.5mile.search <- plm(log(TotalMonthlySales + 1) ~ DID + THREEINTER, data = data_5m_t6_search[data_5m_t6_search$domain_name == "bestbuy.com",], index = c("Zip_Code", "Time"), model = "within", effect = "twoways")

stargazer(ama.t6.0mile.exp, ama.t6.5mile.exp, ama.t6.0mile.search, ama.t6.5mile.search,
          bb.t6.0mile.exp, bb.t6.5mile.exp, bb.t6.0mile.search, bb.t6.5mile.search,
          ...
          column.labels=c("Amazon-0 Mile-Exp","Amazon-5 Miles-Exp", "Amazon-0 Mile-Search","Amazon-5 Miles-Search", "BestBuy-0 Mile-Exp","BestBuy-5 Miles-Exp", "BestBuy-0 Mile-Exp", "BestBuy-5 Miles-Search"))
