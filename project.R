...
#  remove some data to make presentation clear
rm(ama.t4.0mile, data_0m_t4, data_0m_t5, data_5m_t4, data_5m_t5)
...
ama.t11.0mile <- plm(log(TotalMonthlySales + 1) ~ CCStorePresent + AfterStoreClosing + BBStorePresent + CCStorePresent:AfterStoreClosing + CCStorePresent:AfterStoreClosing:BBStorePresent, data = data_0m_t11[(data_0m_t11$domain_name == "amazon.com") & (data_0m_t11$Zipmatch == 1),], index = c("Zip_Code", "MonthYear"), model = "within", effect = "twoways")
summary(ama.t11.0mile)
ama.t11.pagesperdollar.0mile <- plm(log(PagesPerDollar + 1) ~ CCStorePresent:AfterStoreClosing + CCStorePresent:AfterStoreClosing:BBStorePresent, data = data_0m_t11[(data_0m_t11$domain_name == "amazon.com") & (data_0m_t11$Zipmatch == 1),], index = c("Zip_Code", "MonthYear"), model = "within", effect = "twoways")
summary(ama.t11.pagesperdollar.0mile)
ama.t11.minsperdollar.0mile <- plm(log(MinsPerDollar + 1) ~ CCStorePresent:AfterStoreClosing + CCStorePresent:AfterStoreClosing:BBStorePresent, data = data_0m_t11[(data_0m_t11$domain_name == "amazon.com") & (data_0m_t11$Zipmatch == 1),], index = c("Zip_Code", "MonthYear"), model = "within", effect = "twoways")
summary(ama.t11.minsperdollar.0mile)
...
bb.t11.0mile <- plm(log(TotalMonthlySales + 1) ~ CCStorePresent + AfterStoreClosing + BBStorePresent + CCStorePresent:AfterStoreClosing + CCStorePresent:AfterStoreClosing:BBStorePresent, data = data_0m_t11[(data_0m_t11$domain_name == "bestbuy.com") & (data_0m_t11$Zipmatch == 1),], index = c("Zip_Code", "MonthYear"), model = "within", effect = "twoways")
summary(bb.t11.0mile)
bb.t11.pagesperdollar.0mile <- plm(log(PagesPerDollar + 1) ~ CCStorePresent:AfterStoreClosing + CCStorePresent:AfterStoreClosing:BBStorePresent, data = data_0m_t11[(data_0m_t11$domain_name == "bestbuy.com") & (data_0m_t11$Zipmatch == 1),], index = c("Zip_Code", "MonthYear"), model = "within", effect = "twoways")
summary(bb.t11.pagesperdollar.0mile)
bb.t11.minsperdollar.0mile <- plm(log(MinsPerDollar + 1) ~ CCStorePresent:AfterStoreClosing + CCStorePresent:AfterStoreClosing:BBStorePresent, data = data_0m_t11[(data_0m_t11$domain_name == "bestbuy.com") & (data_0m_t11$Zipmatch == 1),], index = c("Zip_Code", "MonthYear"), model = "within", effect = "twoways")
summary(bb.t11.minsperdollar.0mile)
