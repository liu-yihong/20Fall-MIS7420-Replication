...
\begin{table}[!htbp] \centering 
	...
	\begin{tabular}{@{\extracolsep{5pt}}lD{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} } 
		...
		\cline{2-5} 
		\\[-1.8ex] & \multicolumn{4}{c}{log(TotalMonthlySales)} \\ 
		...
		R$^{2}$ & \multicolumn{1}{c}{0.0004} & \multicolumn{1}{c}{0.001} & \multicolumn{1}{c}{0.00002} & \multicolumn{1}{c}{0.016} \\ 
		Adjusted R$^{2}$ & \multicolumn{1}{c}{-1.321} & \multicolumn{1}{c}{-1.236} & \multicolumn{1}{c}{-7.244} & \multicolumn{1}{c}{-6.931} \\ 
		F Statistic & \multicolumn{1}{c}{0.385 (df = 2; 2128)} & \multicolumn{1}{c}{0.760 (df = 2; 2487)} & \multicolumn{1}{c}{0.002 (df = 1; 82)} & \multicolumn{1}{c}{0.797 (df = 2; 96)} \\ 
		\hline 
		\hline \\[-1.8ex] 
