...
\pagebreak
\subsection{Table 4}
In order to examine whether a competing online retailer benefits from the presence of a local showroom, we run the following regressionsfor Amazon.com and BestBuy.com:
\begin{equation}
	\begin{aligned}
