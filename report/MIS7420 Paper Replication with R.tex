...
\begin{table}[!htbp] \centering 
	...
	\begin{tabular}{@{\extracolsep{5pt}}lD{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} } 
		...
		\cline{2-5} 
		\\[-1.8ex] & \multicolumn{4}{c}{log(TotalMonthlySales + 1)} \\ 
		...
		& (0.669) & (0.245) &  & (1.235) \\ 
		\hline \\[-1.8ex] 
		Observations & \multicolumn{1}{c}{5,089} & \multicolumn{1}{c}{5,740} & \multicolumn{1}{c}{725} & \multicolumn{1}{c}{831} \\ 
		R$^{2}$ & \multicolumn{1}{c}{0.0002} & \multicolumn{1}{c}{0.001} & \multicolumn{1}{c}{0.0001} & \multicolumn{1}{c}{0.012} \\ 
		Adjusted R$^{2}$ & \multicolumn{1}{c}{-1.293} & \multicolumn{1}{c}{-1.209} & \multicolumn{1}{c}{-6.869} & \multicolumn{1}{c}{-6.593} \\ 
		F Statistic & \multicolumn{1}{c}{0.196 (df = 2; 2219)} & \multicolumn{1}{c}{0.716 (df = 2; 2596)} & \multicolumn{1}{c}{0.005 (df = 1; 92)} & \multicolumn{1}{c}{0.653 (df = 2; 108)} \\ 
		\hline 
		\hline \\[-1.8ex] 
...
\begin{table}[!htbp] \centering 
	...
	\begin{tabular}{@{\extracolsep{5pt}}lD{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} } 
		...
		& \multicolumn{4}{c}{\textit{Dependent variable:}} \\ 
		\cline{2-5} 
		\\[-1.8ex] & \multicolumn{4}{c}{log(PagesPerDollar + 1)} \\ 
		\\[-1.8ex] & \multicolumn{1}{c}{(1)} & \multicolumn{1}{c}{(2)} & \multicolumn{1}{c}{(3)} & \multicolumn{1}{c}{(4)}\\ 
		\hline \\[-1.8ex] 
		...
		\hline \\[-1.8ex] 
		Observations & \multicolumn{1}{c}{5,089} & \multicolumn{1}{c}{5,740} & \multicolumn{1}{c}{725} & \multicolumn{1}{c}{831} \\ 
		R$^{2}$ & \multicolumn{1}{c}{0.0005} & \multicolumn{1}{c}{0.0001} & \multicolumn{1}{c}{0.005} & \multicolumn{1}{c}{0.009} \\ 
		Adjusted R$^{2}$ & \multicolumn{1}{c}{-1.292} & \multicolumn{1}{c}{-1.211} & \multicolumn{1}{c}{-6.829} & \multicolumn{1}{c}{-6.615} \\ 
		F Statistic & \multicolumn{1}{c}{0.531 (df = 2; 2219)} & \multicolumn{1}{c}{0.120 (df = 2; 2596)} & \multicolumn{1}{c}{0.477 (df = 1; 92)} & \multicolumn{1}{c}{0.499 (df = 2; 108)} \\ 
		\hline 
		\hline \\[-1.8ex] 
		\textit{Note:}  & \multicolumn{4}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\ 
	\end{tabular} 
