...
\lstinputlisting[language=R, caption={Estimating Treatment Effects on Amazon Sales (Zero Mile) with Causal Forests}, label={lst:ama_cf_d1}, linerange={223-257}]{../celik_beyza_causal_forest.R}
...
\lstinputlisting[language=R, caption={Estimating Treatment Effects on \texttt{PagesPerDollar} (Zero Mile) with Causal Forests}, label={lst:ama_cf_d1}, linerange={345-391}]{../celik_beyza_causal_forest.R}
...
\lstinputlisting[language=R, caption={Estimating Treatment Effects on \texttt{PagesPerDollar} (Zero Mile) with Causal Forests}, label={lst:ama_cf_d1}, linerange={532-585}]{../celik_beyza_causal_forest.R}
